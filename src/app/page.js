          ...
          {filteredVerbs.map((verb) => (
            <Link key={verb.id} href={`/verbs/${verb.id}`}>
              <div className="bg-[#706F6F] border-4 border-[#000000] p-6 
                ...
                <div className="text-3xl sm:text-4xl text-right mb-2 sm:mb-3 text-[#FFD700] font-arabic">
                  {verb.word}
                </div>
                <div className={`${pressStart2P.className} text-[10px] sm:text-xs text-right`}>
